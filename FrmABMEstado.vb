    ...
    Private Sub Cmdagregar_Click(sender As Object, e As EventArgs) Handles Cmdagregar.Click
        ...
        If lblseñal.Text = "AGREGAR" Then
            ...
            Try
                ...
                acciones.CommandText = "INSERT INTO Estado(Descripcion, Activo)VALUES('" & txtDescripcion.Text & "','" & cbActivo.Text & "')"
        ...
        If lblseñal.Text = "MODIFICAR" Then
            ...
            Try
                ...
                acciones.Connection = conexionSql
                acciones.CommandType = CommandType.Text
                acciones.CommandText = "UPDATE Estado SET Descripcion = '" & txtDescripcion.Text & "' ,Activo = '" & cbActivo.Text & "'  where ID = " & txtid.Text & ""
                acciones.ExecuteNonQuery()
