...
Public Class InfVentaxPeriodo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Negocio.InfVentaxPeriodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfVentaxPeriodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfVentaxPeriodo = New InfVentaxPeriodo()
        rpt.Site = Me.Site
        Return rpt
    End Function
